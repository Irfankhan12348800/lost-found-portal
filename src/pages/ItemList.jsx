...
function ItemList() {
  ...
  return (
    <div className="max-w-6xl mx-auto mt-10 px-4">
      <h2 className="text-3xl font-bold text-center text-blue-700 mb-6">📦 Reported Items</h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {Items.map((Item, index) => (
            ...
            >
              ...
              <p className="text-sm text-gray-500 mt-1"><strong>Category:</strong> {Item.category}</p>
              <p className="text-sm text-gray-500"><strong>Contact:</strong> {Item.contact}</p>
            </div>
          ))}
        </div>
      )}
